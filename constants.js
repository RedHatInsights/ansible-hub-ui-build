...
var Constants = /** @class */ (function () {
    ...
    Constants.TASK_NAMES = {
        'galaxy_ng.app.tasks.promotion._remove_content_from_repository': t(templateObject_47 || (templateObject_47 = __makeTemplateObject(["Remove content from repository"], ["Remove content from repository"]))),
        'galaxy_ng.app.tasks.publishing.import_and_auto_approve': t(templateObject_48 || (templateObject_48 = __makeTemplateObject(["Import and auto approve"], ["Import and auto approve"]))),
        'galaxy_ng.app.tasks.curate_synclist_repository': t(templateObject_49 || (templateObject_49 = __makeTemplateObject(["Curate synclist repository"], ["Curate synclist repository"]))),
        'galaxy_ng.app.tasks.import_and_move_to_staging': t(templateObject_50 || (templateObject_50 = __makeTemplateObject(["Import and move to staging"], ["Import and move to staging"]))),
        'galaxy_ng.app.tasks.import_and_auto_approve': t(templateObject_51 || (templateObject_51 = __makeTemplateObject(["Import and auto approve"], ["Import and auto approve"]))),
        'galaxy_ng.app.tasks.curate_all_synclist_repository': t(templateObject_52 || (templateObject_52 = __makeTemplateObject(["Curate all synclist repository"], ["Curate all synclist repository"]))),
        'galaxy_ng.app.tasks.synclist.curate_synclist_repository_batch': t(templateObject_53 || (templateObject_53 = __makeTemplateObject(["Curate synclist repository batch"], ["Curate synclist repository batch"]))),
        'pulp_ansible.app.tasks.collections.sync': t(templateObject_54 || (templateObject_54 = __makeTemplateObject(["Pulp Ansible: Collections sync"], ["Pulp Ansible: Collections sync"]))),
        'pulp_ansible.app.tasks.copy.copy_content': t(templateObject_55 || (templateObject_55 = __makeTemplateObject(["Pulp ansible: Copy content"], ["Pulp ansible: Copy content"]))),
        'pulp_ansible.app.tasks.collections.collection_sync': t(templateObject_56 || (templateObject_56 = __makeTemplateObject(["Pulp ansible: collection sync"], ["Pulp ansible: collection sync"]))),
        'pulp_ansible.app.tasks.roles.synchronize': t(templateObject_57 || (templateObject_57 = __makeTemplateObject(["Pulp Ansible: Roles synchronize"], ["Pulp Ansible: Roles synchronize"]))),
        'pulp_ansible.app.tasks.collections.update_collection_remote': t(templateObject_58 || (templateObject_58 = __makeTemplateObject(["Pulp ansible: Update collection remote"], ["Pulp ansible: Update collection remote"]))),
        'pulp_ansible.app.tasks.collections.import_collection': t(templateObject_59 || (templateObject_59 = __makeTemplateObject(["Pulp ansible: Import collection"], ["Pulp ansible: Import collection"]))),
        'pulp_container.app.tasks.tag_image': t(templateObject_60 || (templateObject_60 = __makeTemplateObject(["Pulp container: Tag image"], ["Pulp container: Tag image"]))),
        'pulp_container.app.tasks.untag_image': t(templateObject_61 || (templateObject_61 = __makeTemplateObject(["Pulp container: Untage image"], ["Pulp container: Untage image"]))),
        'pulp_container.app.tasks.synchronize': t(templateObject_62 || (templateObject_62 = __makeTemplateObject(["Pulp container: Tasks synchronize"], ["Pulp container: Tasks synchronize"]))),
        'pulp_container.app.tasks.recursive_add_content': t(templateObject_63 || (templateObject_63 = __makeTemplateObject(["Pulp container: Recursive add content"], ["Pulp container: Recursive add content"]))),
        'pulp_container.app.tasks.recursive_remove_content': t(templateObject_64 || (templateObject_64 = __makeTemplateObject(["Pulp container: Recursive remove content"], ["Pulp container: Recursive remove content"]))),
        'pulp_container.app.tasks.build_image_from_containerfile': t(templateObject_65 || (templateObject_65 = __makeTemplateObject(["Pulp container: Build image from containerfile"], ["Pulp container: Build image from containerfile"]))),
        'pulp_container.app.tasks.general_multi_delete': t(templateObject_66 || (templateObject_66 = __makeTemplateObject(["Pulp container: General multi delete"], ["Pulp container: General multi delete"]))),
        'pulpcore.tasking.tasks.import_repository_version': t(templateObject_67 || (templateObject_67 = __makeTemplateObject(["Pulpcore: Import repository version"], ["Pulpcore: Import repository version"]))),
        'pulpcore.tasking.tasks.orphan_cleanup': t(templateObject_68 || (templateObject_68 = __makeTemplateObject(["Pulpcore: Orphan cleanup"], ["Pulpcore: Orphan cleanup"]))),
        'pulpcore.tasking.tasks.repair_all_artifacts': t(templateObject_69 || (templateObject_69 = __makeTemplateObject(["Pulpcore: Repair all artifacts"], ["Pulpcore: Repair all artifacts"]))),
        'pulpcore.tasking.tasks.base.general_create': t(templateObject_70 || (templateObject_70 = __makeTemplateObject(["Pulpcore: General create"], ["Pulpcore: General create"]))),
        'pulpcore.tasking.tasks.base.general_update': t(templateObject_71 || (templateObject_71 = __makeTemplateObject(["Pulpcore: General update"], ["Pulpcore: General update"]))),
        'pulpcore.tasking.tasks.base.general_delete': t(templateObject_72 || (templateObject_72 = __makeTemplateObject(["Pulpcore: General delete"], ["Pulpcore: General delete"]))),
        'pulpcore.app.tasks.export.pulp_export': t(templateObject_73 || (templateObject_73 = __makeTemplateObject(["Pulpcore: Pulp export"], ["Pulpcore: Pulp export"]))),
        'pulpcore.app.tasks.pulp_import': t(templateObject_74 || (templateObject_74 = __makeTemplateObject(["Pulpcore: Pulp import"], ["Pulpcore: Pulp import"]))),
        'pulpcore.app.tasks.repository.delete_version': t(templateObject_75 || (templateObject_75 = __makeTemplateObject(["Pulpcore: Delete version"], ["Pulpcore: Delete version"]))),
        'pulpcore.app.tasks.repository.repair_version': t(templateObject_76 || (templateObject_76 = __makeTemplateObject(["Pulpcore: Repair version"], ["Pulpcore: Repair version"]))),
        'pulpcore.app.tasks.upload.commit': t(templateObject_77 || (templateObject_77 = __makeTemplateObject(["Pulpcore: Upload commit"], ["Pulpcore: Upload commit"]))),
        'pulpcore.app.tasks.repository.add_and_remove': t(templateObject_78 || (templateObject_78 = __makeTemplateObject(["Pulpcore: Add and remove"], ["Pulpcore: Add and remove"]))),
        'pulpcore.plugin.tasking.add_and_remove': t(templateObject_79 || (templateObject_79 = __makeTemplateObject(["Pulpcore: Add or remove"], ["Pulpcore: Add or remove"]))),
    };
    return Constants;
}());
export { Constants };
