        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, AnsibleDistributionAPI.list({
                        ...
                        .catch(function (e) {
                        handleHttpError(t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Failed to list distributions, removing only the repository."], ["Failed to list distributions, removing only the repository."]))), function () { return null; }, addAlert)(e);
                        return [];
                    })];
                case 1:
                    distributionsToDelete = _c.sent();
                    deleteRepo = AnsibleRepositoryAPI.delete(pulpId)
                        .then(function (_a) {
                        var data = _a.data;
                    ...
                    deleteDistribution = function (_a) {
                        ...
                        var distribution_id = parsePulpIDFromURL(pulp_href);
                    ...
                    return [2 /*return*/, Promise.all(__spreadArray([
                            deleteRepo
