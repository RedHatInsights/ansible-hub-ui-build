...
var CollectionDocs = /** @class */ (function (_super) {
    ...
    CollectionDocs.prototype.render = function () {
        ...
        if (contentType === 'docs' && contentName) {
            ...
            if (collection.latest_version.docs_blob.contents) {
                var content = collection.latest_version.docs_blob.contents.find(function (x) { return x.content_type === contentType && x.content_name === contentName; });
                if (content) {
                    if (contentType === 'role') {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(Main, { className: 'main' },
                React.createElement(Section, { className: 'docs-container' },
                    React.createElement(TableOfContents, { className: 'sidebar', namespace: collection.namespace.name, collection: collection.name, docs_blob: collection.latest_version.docs_blob, selectedName: contentName, selectedType: contentType, params: params }),
    ...
    CollectionDocs.prototype.renderNotFound = function (collectionName) {
        return (React.createElement(EmptyStateCustom, { title: 'Not found', description: 'The file is not available for this version of ' + collectionName, icon: ExclamationCircleIcon }));
    };
