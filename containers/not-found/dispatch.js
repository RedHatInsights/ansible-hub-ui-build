    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Main, null,
            ...
            featureFlags.legacy_roles ? (React.createElement(React.Fragment, null,
                React.createElement(SectionSeparator, null),
                React.createElement(PageSection, null,
                    React.createElement(SectionTitle, null, t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Roles"], ["Roles"])))),
                    roles === null ? (React.createElement(LoadingPageSpinner, null)) : roles.length === 0 ? (React.createElement(EmptyStateNoData, { title: t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["No matching roles found."], ["No matching roles found."]))), description: React.createElement(Link, { to: formatPath(Paths.legacyRoles) }, t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Show all roles"], ["Show all roles"])))) })) : (React.createElement(React.Fragment, null,
                        React.createElement(DataList, { "aria-label": t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Available matching roles"], ["Available matching roles"]))) }, roles.map(function (r) { return (React.createElement(LegacyRoleListItem, { key: r.id, role: r, show_thumbnail: true })); })),
                        React.createElement(Link, { to: formatPath(Paths.legacyRoles) }, t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Show all roles"], ["Show all roles"]))))))))) : null)));
};
