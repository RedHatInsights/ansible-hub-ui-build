...
import { AnsibleRemoteAPI, GroupAPI, UserAPI, } from 'src/api';
...
export var RemoteAccessTab = function (_a) {
    ...
    return (React.createElement(AccessTab, { addGroup: addGroup, addRole: addRole, addUser: addUser, addUserRole: addUserRole, canEditOwners: canEditOwners, group: selectedGroup, groups: groups, name: name, pulpObjectType: 'remotes/ansible/collection', removeGroup: removeGroup, removeRole: removeRole, removeUser: removeUser, removeUserRole: removeUserRole, selectRolesMessage: t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["The selected roles will be added to this specific Ansible remote."], ["The selected roles will be added to this specific Ansible remote."]))), showGroupRemoveModal: showGroupRemoveModal, showGroupSelectWizard: showGroupSelectWizard, showRoleRemoveModal: showRoleRemoveModal, showRoleSelectWizard: showRoleSelectWizard, showUserRemoveModal: showUserRemoveModal, showUserSelectWizard: showUserSelectWizard, updateProps: updateProps, user: selectedUser, users: users, urlPrefix: formatPath(Paths.ansibleRemoteDetail, {
            name: name,
        }) }));
};
