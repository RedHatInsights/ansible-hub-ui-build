...
var ExecutionEnvironmentManifest = /** @class */ (function (_super) {
    ...
    ExecutionEnvironmentManifest.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(BaseHeader, { title: 'Image layers', breadcrumbs: React.createElement(Breadcrumbs, { links: [
                        {
                ...
                React.createElement(Flex, null,
                    React.createElement(FlexItem, { className: 'layers-max-width' },
                        React.createElement(Section, { className: 'body' },
                            React.createElement(Title, { headingLevel: 'h2', size: 'lg' }, "Image layers"),
                            React.createElement(DataList, { "aria-label": 'Image layers', onSelectDataListItem: function (id) {
                    ...
                    React.createElement(Flex, { direction: { default: 'column' }, className: 'layers-max-width' },
                        React.createElement(FlexItem, null,
                            React.createElement(Section, { className: 'body' },
                                React.createElement(Title, { headingLevel: 'h2', size: 'lg' }, "Command"),
                                React.createElement("code", null, command))),
                        React.createElement(FlexItem, null,
                            React.createElement(Section, { className: 'body' },
                                React.createElement(Title, { headingLevel: 'h2', size: 'lg' }, "Environment"),
