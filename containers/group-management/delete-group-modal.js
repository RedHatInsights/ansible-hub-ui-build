...
var DeleteGroupModal = /** @class */ (function (_super) {
    ...
    DeleteGroupModal.prototype.render = function () {
        ...
        return (React.createElement(DeleteModal, { cancelAction: cancelAction, deleteAction: deleteAction, title: 'Delete group?' },
            ...
            React.createElement("div", null,
                ...
                users && count > 0 && count <= 10 && (React.createElement(React.Fragment, null,
                    React.createElement("p", null, "These users will lose access to the group content:"),
                ...
                users && !count && React.createElement("p", null, "No users will be affected."),
