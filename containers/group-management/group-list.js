...
var GroupList = /** @class */ (function (_super) {
    ...
    GroupList.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(BaseHeader, { title: 'Groups' }),
            unauthorized ? (React.createElement(EmptyStateUnauthorized, null)) : loading ? (React.createElement(LoadingPageSpinner, null)) : noData ? (React.createElement(EmptyStateNoData, { title: 'No groups yet', description: 'Groups will appear once created', button: React.createElement(Button, { variant: 'primary', onClick: function () { return _this.setState({ createModalVisible: true }); } }, "Create") })) : (React.createElement(Main, null,
    ...
    GroupList.prototype.renderTable = function (params) {
        ...
        return (React.createElement("table", { "aria-label": 'Group list', className: 'content-table pf-c-table' },
    ...
    GroupList.prototype.renderTableRow = function (group, index) {
        ...
        return (React.createElement("tr", { "aria-labelledby": group.name, key: index },
            ...
            React.createElement("td", null, !!user && user.model_permissions.delete_group && (React.createElement(Button, { "aria-label": 'Delete', key: 'delete', variant: 'danger', onClick: function () {
                    return _this.setState({
                        selectedGroup: group,
