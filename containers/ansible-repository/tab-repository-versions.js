...
var ContentSummary = function (_a) {
    ...
    return (React.createElement("table", { className: 'pf-c-table' },
        React.createElement("tr", null,
            React.createElement("th", null, t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Count"], ["Count"])))),
            React.createElement("th", null, t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Pulp type"], ["Pulp type"]))))),
...
var BaseVersion = function (_a) {
    ...
    if (!data) {
        return React.createElement(React.Fragment, null, t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["None"], ["None"]))));
    }
        ...
        if (state.params.repositoryVersion) {
            queryDetail({ number: state.params.repositoryVersion }).then(function (_a) {
                ...
                if (!((_b = data === null || data === void 0 ? void 0 : data.results) === null || _b === void 0 ? void 0 : _b[0])) {
                    addAlert({
                        variant: 'danger',
                        title: t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Failed to find repository version"], ["Failed to find repository version"]))),
                    });
                }
    ...
    var renderTableRow = function (item, index, actionContext, listItemActions) {
        ...
        return (React.createElement("tr", { key: index },
            React.createElement("td", null,
                ...
                isLatest ? ' ' + t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["(latest)"], ["(latest)"]))) : null),
            React.createElement("td", null,
                React.createElement(DateComponent, { date: pulp_created })),
            React.createElement(ListItemActions, { kebabItems: kebabItems })));
    };
    return state.params.repositoryVersion ? (version ? (React.createElement(Details, { fields: [
            { label: t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Version number"], ["Version number"]))), value: version.number },
            {
                label: t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Created date"], ["Created date"]))),
                value: React.createElement(DateComponent, { date: version.pulp_created }),
            },
            {
                label: t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Content added"], ["Content added"]))),
                value: React.createElement(ContentSummary, { data: (_b = version.content_summary) === null || _b === void 0 ? void 0 : _b.added }),
            },
            {
                label: t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Content removed"], ["Content removed"]))),
                value: React.createElement(ContentSummary, { data: (_c = version.content_summary) === null || _c === void 0 ? void 0 : _c.removed }),
            },
            {
                label: t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Current content"], ["Current content"]))),
                value: React.createElement(ContentSummary, { data: (_d = version.content_summary) === null || _d === void 0 ? void 0 : _d.present }),
            },
            {
                label: t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Base version"], ["Base version"]))),
                value: (React.createElement(BaseVersion, { repositoryName: repositoryName, data: version.base_version })),
            },
        ] })) : (React.createElement(Spinner, { size: 'md' }))) : (React.createElement(DetailList, { actionContext: {
            addAlert: addAlert,
            state: modalState,
            setState: setModalState,
            query: queryList,
        }, defaultPageSize: 10, defaultSort: '-pulp_created', errorTitle: t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Repository versions could not be displayed."], ["Repository versions could not be displayed."]))), filterConfig: null, listItemActions: [ansibleRepositoryVersionRevertAction], noDataButton: null, noDataDescription: t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Repository versions will appear once the repository is modified."], ["Repository versions will appear once the repository is modified."]))), noDataTitle: t(templateObject_15 || (templateObject_15 = __makeTemplateObject(["No repository versions yet"], ["No repository versions yet"]))), query: queryList, renderTableRow: renderTableRow, sortHeaders: [
            {
                title: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Version number"], ["Version number"]))),
                type: 'numeric',
                id: 'number',
            },
            {
                title: t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Created date"], ["Created date"]))),
                type: 'numeric',
                id: 'pulp_created',
            },
        ], title: t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Repository versions"], ["Repository versions"]))) }));
};
