...
import { AnsibleRepositoryAPI, GroupAPI, } from 'src/api';
...
export var RepositoryAccessTab = function (_a) {
    ...
    var query = function () {
        ...
        AnsibleRepositoryAPI.myPermissions(id)
            ...
            AnsibleRepositoryAPI.listRoles(id)
                ...
                setCanEditOwners(permissions.includes('ansible.change_ansiblerepository') ||
    ...
    return (React.createElement(AccessTab, { addGroup: addGroup, addRole: addRole, canEditOwners: canEditOwners, group: selectedGroup, groups: groups, name: name, pulpObjectType: 'repositories/ansible/ansible', removeGroup: removeGroup, removeRole: removeRole, selectRolesMessage: t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["The selected roles will be added to this specific Ansible repository."], ["The selected roles will be added to this specific Ansible repository."]))), showGroupRemoveModal: showGroupRemoveModal, showGroupSelectWizard: showGroupSelectWizard, showRoleRemoveModal: showRoleRemoveModal, showRoleSelectWizard: showRoleSelectWizard, updateProps: updateProps, urlPrefix: formatPath(Paths.ansibleRepositoryDetail, {
            name: name,
        }) }));
};
