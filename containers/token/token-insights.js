...
var TokenPage = /** @class */ (function (_super) {
    ...
    TokenPage.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(BaseHeader, { title: 'Connect to Hub' }),
            React.createElement(Main, null,
                React.createElement(Section, { className: 'body pf-c-content' },
                    React.createElement("h2", null, "Connect Private Automation Hub"),
                ...
                React.createElement(Section, { className: 'body pf-c-content' },
                    React.createElement("h2", null, "Connect the ansible-galaxy client"),
                    React.createElement("p", null,
                ...
                React.createElement(Section, { className: 'body pf-c-content' },
                    React.createElement("h2", null, "Offline token"),
                    React.createElement("p", null, "Use this token to authenticate clients that need to download content from Automation Hub. This is a secret token used to protect your content. Store your API token in a secure location."),
                    tokenData ? (React.createElement("div", null,
                        React.createElement(ClipboardCopy, null, tokenData.refresh_token))) : (React.createElement(Button, { onClick: function () { return _this.loadToken(); } }, "Load token")),
                    ...
                    React.createElement("h2", null, "Manage tokens"),
                    ...
                    "page."),
                React.createElement(Section, { className: 'body pf-c-content' },
                    React.createElement("h2", null, "Server URL"),
                    React.createElement("p", null, "Use this URL to configure the API endpoints that clients need to download content from Automation Hub."),
                    ...
                    React.createElement("p", null,
                        ...
                        ".")),
                React.createElement(Section, { className: 'body pf-c-content' },
                    React.createElement("h2", null, "SSO URL"),
                    React.createElement("p", null, "Use this URL to configure the authentication URLs that clients need to download content from Automation Hub."),
