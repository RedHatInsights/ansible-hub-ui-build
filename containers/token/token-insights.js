...
var TokenPage = /** @class */ (function (_super) {
    ...
    TokenPage.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(BaseHeader, { title: _(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Connect to Hub"], ["Connect to Hub"]))) }),
            React.createElement(Main, null,
                React.createElement("section", { className: 'body pf-c-content' },
                    React.createElement("h2", null, _(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Connect Private Automation Hub"], ["Connect Private Automation Hub"])))),
                    React.createElement("p", null,
                        "Use the",
                        ' ',
                        React.createElement(Link, { to: Paths.repositories }, _(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Repository Management"], ["Repository Management"])))),
                        ' ',
                        ...
                        ' ',
                        React.createElement(Link, { to: Paths.search }, _(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Collections"], ["Collections"])))),
                        " page to control which collections are added to their organization's sync repository.")),
                React.createElement("section", { className: 'body pf-c-content' },
                    React.createElement("h2", null, _(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Connect the ansible-galaxy client"], ["Connect the ansible-galaxy client"])))),
                    React.createElement("p", null,
                ...
                React.createElement("section", { className: 'body pf-c-content' },
                    React.createElement("h2", null, _(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Offline token"], ["Offline token"])))),
                    React.createElement("p", null, _(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Use this token to authenticate clients that need to download"], ["Use this token to authenticate clients that need to download"]))),
                    ...
                    tokenData ? (React.createElement("div", null,
                        React.createElement(ClipboardCopy, null, tokenData.refresh_token))) : (React.createElement(Button, { onClick: function () { return _this.loadToken(); } }, _(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Load token"], ["Load token"]))))),
                    ...
                    React.createElement("h2", null, _(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Manage tokens"], ["Manage tokens"])))),
                    ...
                    "page."),
                React.createElement("section", { className: 'body pf-c-content' },
                    React.createElement("h2", null, _(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Server URL"], ["Server URL"])))),
                    React.createElement("p", null, _(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Use this URL to configure the API endpoints that clients need to"], ["Use this URL to configure the API endpoints that clients need to"]))),
                        "download content from Automation Hub."),
                    React.createElement(ClipboardCopy, { isReadOnly: true }, getRepoUrl('')),
                    React.createElement("p", null, _(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Note: this URL contains all collections in Hub. To connect to your"], ["Note: this URL contains all collections in Hub. To connect to your"]))),
                        "organization's sync repository use the URL found on",
                        ' ',
                        React.createElement(Link, { to: Paths.repositories }, _(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Repository Management"], ["Repository Management"])))),
                        ".")),
                React.createElement("section", { className: 'body pf-c-content' },
                    React.createElement("h2", null, _(templateObject_14 || (templateObject_14 = __makeTemplateObject(["SSO URL"], ["SSO URL"])))),
                    React.createElement("p", null, _(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Use this URL to configure the authentication URLs that clients"], ["Use this URL to configure the authentication URLs that clients"]))),
