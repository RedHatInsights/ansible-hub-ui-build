...
var NamespaceList = /** @class */ (function (_super) {
    ...
    NamespaceList.prototype.render = function () {
        ...
        if ((_a = user === null || user === void 0 ? void 0 : user.model_permissions) === null || _a === void 0 ? void 0 : _a.add_namespace) {
            extra.push(React.createElement(ToolbarItem, { key: 'create-button' },
                React.createElement(Button, { variant: 'primary', onClick: this.handleModalToggle }, "Create")));
        }
        ...
        return (React.createElement("div", { className: 'namespace-page' },
            ...
            React.createElement(BaseHeader, { title: title },
                ...
                noData ? null : (React.createElement("div", { className: 'toolbar' },
                    React.createElement(Toolbar, { params: params, sortOptions: [{ title: 'Name', id: 'name', type: 'alpha' }], searchPlaceholder: search, updateParams: function (p) {
    ...
    NamespaceList.prototype.renderBody = function () {
        ...
        var user = this.context.user;
        var noDataTitle = 'No namespaces yet';
        var noDataDescription = !filterOwner
            ? 'Namespaces will appear once created'
            : 'This account is not set up to manage any namespaces';
        var noDataButton = ((_a = user === null || user === void 0 ? void 0 : user.model_permissions) === null || _a === void 0 ? void 0 : _a.add_namespace) ? (React.createElement(Button, { variant: 'primary', onClick: function () { return _this.handleModalToggle(); } }, "Create")) : null;
        if (loading) {
