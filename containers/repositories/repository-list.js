...
var RepositoryList = /** @class */ (function (_super) {
        ...
        return (React.createElement(React.Fragment, null,
            remoteToEdit && showRemoteFormModal && (React.createElement(RemoteForm, { remote: remoteToEdit, updateRemote: function (r) { return _this.setState({ remoteToEdit: r }); }, saveRemote: function () {
                    ...
                    try {
                        ...
                        _this.setState({
                            errorMessages: {
                                __nofield: "Can't update remote without a distribution attached to it.",
                            },
                        });
                    }
            ...
            React.createElement(BaseHeader, { title: 'Repo Management' }, DEPLOYMENT_MODE === Constants.STANDALONE_DEPLOYMENT_MODE &&
    ...
    RepositoryList.prototype.renderContent = function (params, content) {
        ...
        if (!!params.tab && params.tab.toLowerCase() === 'remote') {
            return content.length === 0 ? (React.createElement(EmptyStateNoData, { title: 'No remote repositories yet', description: 'Remote repositories will appear once added' })) : (React.createElement(Main, { className: 'repository-list' },
                React.createElement(Section, { className: 'body' },
