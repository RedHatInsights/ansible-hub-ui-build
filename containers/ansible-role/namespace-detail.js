...
var NamespaceRoles = /** @class */ (function (_super) {
    __extends(NamespaceRoles, _super);
    // This is the list of roles that is shown on
    // the legacy namespace details page.
    function NamespaceRoles(props) {
    ...
    NamespaceRoles.prototype.componentDidMount = function () {
        var _this = this;
    ...
    NamespaceRoles.prototype.render = function () {
        var _a = this.state, loading = _a.loading, roles = _a.roles;
        var noData = roles === null || roles.length === 0;
        return (React.createElement("div", null, loading ? (React.createElement(LoadingPageSpinner, null)) : noData ? (React.createElement(EmptyStateNoData, { title: t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["No roles yet"], ["No roles yet"]))), description: t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Roles will appear once imported"], ["Roles will appear once imported"]))) })) : (React.createElement("div", null,
...
var AnsibleRoleNamespaceDetail = /** @class */ (function (_super) {
    __extends(AnsibleRoleNamespaceDetail, _super);
    // This is the details page for a legacy namespace
    function AnsibleRoleNamespaceDetail(props) {
        var _this = _super.call(this, props) || this;
    ...
    AnsibleRoleNamespaceDetail.prototype.addAlert = function (alert) {
        this.setState({
            alerts: __spreadArray(__spreadArray([], this.state.alerts, true), [alert], false),
        });
    };
    Object.defineProperty(AnsibleRoleNamespaceDetail.prototype, "closeAlert", {
        get: function () {
    ...
    AnsibleRoleNamespaceDetail.prototype.componentDidMount = function () {
        var _this = this;
    ...
    AnsibleRoleNamespaceDetail.prototype.render = function () {
        var _this = this;
        var _a;
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(DataList, { "aria-label": t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Role namespace header"], ["Role namespace header"]))), className: 'hub-legacy-namespace-page' },
                React.createElement(DataListItem, null,
                    React.createElement(DataListItemRow, null,
                        React.createElement(DataListItemCells, { dataListCells: infocells })))),
            React.createElement(NamespaceRoles, { namespace: this.state.namespace })));
    };
    AnsibleRoleNamespaceDetail.contextType = AppContext;
    return AnsibleRoleNamespaceDetail;
}(React.Component));
