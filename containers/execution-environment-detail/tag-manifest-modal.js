...
var TagManifestModal = /** @class */ (function (_super) {
    ...
    TagManifestModal.prototype.render = function () {
        ...
        return (React.createElement(Modal, { actions: [
                React.createElement(Button, { key: 'save', onClick: function () { return _this.saveTags(); }, isDisabled: isSaving || (tagsToAdd.length <= 0 && tagsToRemove.length <= 0) },
                    "Save",
                    isSaving && React.createElement(Spinner, { size: 'sm' })),
                React.createElement(Button, { isDisabled: isSaving, key: 'cancel', onClick: function () { return closeModal(); }, variant: 'link' }, "Cancel"),
            ], isOpen: isOpen, onClose: function () { return closeModal(); }, title: 'Manage tags', variant: 'small' },
            React.createElement(Form, { onSubmit: function (e) { return e.preventDefault(); } },
                React.createElement(FormGroup, { validated: !!tagInFormError ? 'error' : 'default', helperTextInvalid: tagInFormError, fieldId: 'add-new-tag', label: 'Add new tag' },
                ...
                tagToVerify && (React.createElement(Alert, { variant: 'warning', isInline: true, title: 'This tag already exists on another image. Do you want to move it to this image?', actionLinks: React.createElement(React.Fragment, null,
                        ...
                        React.createElement(AlertActionLink, { onClick: function () { return _this.setState({ tagToVerify: '' }); } }, "No")) })),
                React.createElement(FormGroup, { fieldId: 'remove-tag', label: 'Current tags' },
                ...
                pendingTasks > 0 && (React.createElement(Alert, { isInline: true, variant: 'info', title: React.createElement(React.Fragment, null,
                        "Waiting for ",
                        pendingTasks,
                        " task(s) to finish.") }, "It's safe to close this window. These tasks will finish in the background.")))));
    };
    ...
    TagManifestModal.prototype.verifyTag = function (tag) {
        ...
        if (!this.validateTagName(tag)) {
            this.setState({
                verifyingTag: false,
                tagInFormError: 'A tag may contain lowercase and uppercase ASCII ' +
            ...
            this.setState({
                verifyingTag: false,
                tagInFormError: 'This tag is already selected for this image. You cannot add it twice.',
            });
        }
        else {
