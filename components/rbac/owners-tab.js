...
import { DeleteModal, EmptyStateNoData, ExpandableRow, GroupRolePermissions, ListItemActions, LoadingPageSpinner, PreviewRoles, RoleListTable, SelectGroup, SelectRoles, SortTable, WizardModal, EmptyStateCustom, } from 'src/components';
...
var OwnersTab = /** @class */ (function (_super) {
    ...
    OwnersTab.prototype.render = function () {
        var _this = this;
        var _a = this.props, groups = _a.groups, groupId = _a.groupId;
        ...
        return loading ? (React.createElement(LoadingPageSpinner, null)) : (React.createElement(React.Fragment, null,
            ...
            !this.context.user.is_superuser &&
                !this.context.user.model_permissions.view_group ? (React.createElement(EmptyStateCustom, { title: t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["You do not have the required permissions."], ["You do not have the required permissions."]))), description: t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Please contact the server administrator for elevated permissions."], ["Please contact the server administrator for elevated permissions."]))), icon: ExclamationTriangleIcon })) : noData ? (React.createElement(EmptyStateNoData, { title: t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["There are currently no owners assigned."], ["There are currently no owners assigned."]))), description: t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Please add an owner by using the button below."], ["Please add an owner by using the button below."]))), button: buttonAdd })) : groupId ? (this.renderRoles({ groupId: groupId })) : (this.renderGroups({ buttonAdd: buttonAdd, groups: groups }))));
    };
    OwnersTab.prototype.renderGroups = function (_a) {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement("table", { "aria-label": t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Group list"], ["Group list"]))), className: 'hub-c-table-content pf-c-table' },
                React.createElement(SortTable, { options: {
                        headers: [
                            {
                                title: t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Group"], ["Group"]))),
                                type: 'none',
                                id: 'name',
                            },
                            {
    ...
    OwnersTab.prototype.renderGroupRow = function (group, index) {
        ...
        var dropdownItems = [
            this.context.user.model_permissions.change_containernamespace && (React.createElement(DropdownItem, { key: 'remove', onClick: function () {
                    _this.setState({
    ...
    OwnersTab.prototype.renderRoles = function (_a) {
        ...
        var buttonAdd = this.context.user.is_superuser && (React.createElement(Button, { onClick: function () {
                return _this.setState({
                    showRoleSelectWizard: {},
                });
            } }, t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Add roles"], ["Add roles"])))));
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(RoleListTable, { params: {}, updateParams: function () { return null; }, tableHeader: {
                    headers: [
                        ...
                        {
                            title: t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Role"], ["Role"]))),
                            type: 'none',
                            id: 'role',
                        },
                        {
                ...
                React.createElement(ListItemActions, { kebabItems: [
                        _this.context.user.is_superuser && (React.createElement(DropdownItem, { key: 'remove-role', onClick: function () {
                                return _this.setState({ showRoleRemoveModal: role });
                            } }, t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Remove role"], ["Remove role"]))))),
                    ] }))); }))));
    };
    OwnersTab.prototype.renderGroupRemoveModal = function () {
        ...
        return (React.createElement(DeleteModal, { cancelAction: function () { return _this.setState({ showGroupRemoveModal: null }); }, deleteAction: function () { return _this.removeGroup(group); }, title: t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Remove group ", "?"], ["Remove group ", "?"])), groupname) },
    ...
    OwnersTab.prototype.renderRoleRemoveModal = function (group) {
        ...
        return (React.createElement(DeleteModal, { cancelAction: function () { return _this.setState({ showRoleRemoveModal: null }); }, deleteAction: function () { return _this.removeRole(role, group); }, title: t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Remove role ", "?"], ["Remove role ", "?"])), role) },
            React.createElement(Trans, null,
                "You are about to remove ",
    ...
    OwnersTab.prototype.renderGroupSelectWizard = function () {
        ...
        var steps = [
            {
                id: 0,
                name: t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Select a group"], ["Select a group"]))),
                ...
                backButtonText: t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Cancel"], ["Cancel"]))),
                enableNext: hasGroup,
            },
            {
                id: 1,
                name: t(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Select role(s)"], ["Select role(s)"]))),
            ...
            {
                id: 2,
                name: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Preview"], ["Preview"]))),
                component: React.createElement(PreviewRoles, { group: group, selectedRoles: roles }),
                nextButtonText: t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Add"], ["Add"]))),
                canJumpTo: hasGroup && hasRoles,
                isFinished: true,
            },
        ];
        return (React.createElement(WizardModal, { steps: steps, title: t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Select a group"], ["Select a group"]))), onClose: function () {
                return _this.setState({
                    showGroupSelectWizard: null,
                });
    ...
    OwnersTab.prototype.renderRoleSelectWizard = function (group) {
        ...
        var steps = [
            {
                id: 0,
                name: t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Select role(s)"], ["Select role(s)"]))),
                component: (React.createElement(SelectRoles, { assignedRoles: assignedRoles, selectedRoles: roles, onRolesUpdate: function (roles) {
                        return _this.setState({ showRoleSelectWizard: { roles: roles } });
                    }, pulpObjectType: pulpObjectType })),
                backButtonText: t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Cancel"], ["Cancel"]))),
                enableNext: hasRoles,
            },
            {
                id: 1,
                name: t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Preview"], ["Preview"]))),
                component: React.createElement(PreviewRoles, { group: group, selectedRoles: roles }),
                nextButtonText: t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Add"], ["Add"]))),
                canJumpTo: hasRoles,
                isFinished: true,
            },
        ];
        return (React.createElement(WizardModal, { steps: steps, title: t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Select role(s)"], ["Select role(s)"]))), onClose: function () {
                return _this.setState({
                    showRoleSelectWizard: null,
                });
    ...
    OwnersTab.prototype.addGroup = function (group, roles) {
        ...
        return this.updateGroups({
            ...
            alertSuccess: t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Group \"", "\" has been successfully added to \"", "\"."], ["Group \"", "\" has been successfully added to \"", "\"."])), group.name, name),
            alertFailure: t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["Group \"", "\" could not be added to \"", "\"."], ["Group \"", "\" could not be added to \"", "\"."])), group.name, name),
        });
    };
    OwnersTab.prototype.removeGroup = function (group) {
        ...
        return this.updateGroups({
            ...
            alertSuccess: t(templateObject_26 || (templateObject_26 = __makeTemplateObject(["Group \"", "\" has been successfully removed from \"", "\"."], ["Group \"", "\" has been successfully removed from \"", "\"."])), group.name, name),
            alertFailure: t(templateObject_27 || (templateObject_27 = __makeTemplateObject(["Group \"", "\" could not be removed from \"", "\"."], ["Group \"", "\" could not be removed from \"", "\"."])), group.name, name),
        });
    };
