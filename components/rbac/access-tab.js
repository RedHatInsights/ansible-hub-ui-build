...
var AccessTab = /** @class */ (function (_super) {
    ...
    AccessTab.prototype.renderGroups = function (_a) {
        var _this = this;
    ...
    AccessTab.prototype.renderGroupRow = function (group, index) {
        ...
        return (React.createElement("tr", { "data-cy": "AccessTab-row-".concat(group.name), key: index },
    ...
    AccessTab.prototype.renderRoles = function (_a) {
        var _this = this;
        var group = _a.group;
        var canEditOwners = this.props.canEditOwners;
    ...
    AccessTab.prototype.renderRoleRemoveModal = function (group) {
        var _this = this;
        var groupname = group.name;
        var name = this.props.name;
    ...
    AccessTab.prototype.renderRoleSelectWizard = function (group) {
        var _this = this;
        var _a;
