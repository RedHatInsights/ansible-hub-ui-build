...
var DeleteGroupModal = /** @class */ (function (_super) {
    ...
    DeleteGroupModal.prototype.render = function () {
        var _a = this.props, cancelAction = _a.cancelAction, count = _a.count, deleteAction = _a.deleteAction, name = _a.name, users = _a.users, canViewUsers = _a.canViewUsers;
        return (React.createElement(DeleteModal, { cancelAction: cancelAction, deleteAction: deleteAction, title: t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Delete group?"], ["Delete group?"]))) },
            ...
            React.createElement("div", null,
                ...
                canViewUsers ? (React.createElement(React.Fragment, null,
                    ...
                    !users && (React.createElement("p", null,
                        React.createElement(Trans, null,
                            ...
                            React.createElement(Spinner, { size: 'sm' })))))) : (React.createElement(Alert, { title: t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["This group can include users"], ["This group can include users"]))), variant: 'warning', isInline: true },
                    React.createElement(Trans, null, "You don't have permission to display users."))))));
    };
