    ...
    return (React.createElement(Modal, { actions: [
            React.createElement("div", { "data-cy": 'delete-button', key: 'delete' },
                React.createElement(Button, { key: 'delete', onClick: deleteAction, variant: 'danger', isDisabled: isDisabled },
                    isRemove ? t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Remove"], ["Remove"]))) : t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Delete"], ["Delete"]))),
                    spinner && React.createElement(Spinner, { size: 'sm' }))),
            React.createElement(Button, { key: 'cancel', onClick: cancelAction, variant: 'link' }, t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Cancel"], ["Cancel"])))),
