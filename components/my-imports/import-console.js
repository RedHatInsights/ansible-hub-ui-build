    ...
    ImportConsole.prototype.render = function () {
        ...
        if (loading || apiError) {
            return (React.createElement("div", { className: 'import-console' },
                ...
                React.createElement("div", { className: 'loading message-list' }, apiError ? (React.createElement("div", { className: 'message' }, apiError)) : (React.createElement(Spinner, { centered: false })))));
        }
        this.isLoading =
        ...
        return (React.createElement("div", { className: 'import-console pf-c-content' },
            ...
            React.createElement("div", { className: 'message-list' },
                React.createElement("div", { className: cx({
                    ...
                    React.createElement(Tooltip, { position: 'left', content: this.isLoading ? 'Follow logs' : 'Scroll to end' },
                ...
                task.messages.length === 0 ? (React.createElement("div", { className: 'message' },
                    React.createElement("span", { className: 'error' }, "No task messages available"))) : null,
                task.state === PulpStatus.completed && (React.createElement("div", { className: 'message' },
                    React.createElement("br", null),
                    React.createElement("span", { className: 'success' }, "Done"))),
                task.state === PulpStatus.failed && (React.createElement("div", { className: 'message' },
                    React.createElement("br", null),
                    React.createElement("span", { className: 'failed' }, "Failed")))),
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: 'title-bar' },
                React.createElement("div", null,
                    React.createElement("span", { className: 'data-title' }, "Status: "),
                    React.createElement(StatusIndicator, { type: 'secondary', status: selectedImport.state })),
                React.createElement("div", null,
                    React.createElement("span", { className: 'data-title' }, "Approval status: "),
                    approvalStatus),
                React.createElement("div", null,
                    React.createElement("span", { className: 'data-title' }, "Version: "),
                    selectedImport.version),
                task && task.error ? (React.createElement("div", null,
                    React.createElement("span", { className: 'data-title' }, "Error message: "),
                    task.error.code,
