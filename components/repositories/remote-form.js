    ...
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields, _a) {
        ...
        return (React.createElement(Form, null,
            ...
            !disabledFields.includes('signed_only') && collection_signing ? (React.createElement(FormGroup, { fieldId: 'signed_only', name: t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Signed only"], ["Signed only"]))), label: t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Download only signed collections"], ["Download only signed collections"]))) },
                isCommunityRemote && this.props.remote.signed_only ? (React.createElement(Alert, { isInline: true, variant: 'warning', title: t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Community content will never be synced if this setting is enabled"], ["Community content will never be synced if this setting is enabled"]))) })) : null,
