...
var RemoteForm = /** @class */ (function (_super) {
    ...
    RemoteForm.prototype.render = function () {
        ...
        return (React.createElement(Modal, { isOpen: this.props.showModal, title: 'Edit remote', variant: 'small', onClose: function () { return _this.props.closeModal(); }, actions: [
                React.createElement(Button, { isDisabled: !this.isValid(requiredFields), key: 'confirm', variant: 'primary', onClick: function () { return _this.props.saveRemote(); } }, "Save"),
                React.createElement(Button, { key: 'cancel', variant: 'secondary', onClick: function () { return _this.props.closeModal(); } }, "Cancel"),
    ...
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields) {
        ...
        return (React.createElement(Form, null,
            React.createElement(FormGroup, { fieldId: 'name', label: 'Name', isRequired: requiredFields.includes('name'), validated: this.toError(!('name' in errorMessages)), helperTextInvalid: errorMessages['name'] },
            ...
            React.createElement(FormGroup, { fieldId: 'url', label: 'URL', labelIcon: React.createElement(HelperText, { content: 'The URL of an external content source.' }), isRequired: requiredFields.includes('url'), validated: this.toError(!('url' in errorMessages)), helperTextInvalid: errorMessages['url'] },
            ...
            !disabledFields.includes('token') && (React.createElement(FormGroup, { fieldId: 'token', label: 'Token', labelIcon: React.createElement(HelperText, { content: 'Token for authenticating to the server URL.' }), isRequired: requiredFields.includes('token'), validated: this.toError(!('token' in errorMessages)), helperTextInvalid: errorMessages['token'] },
            ...
            !disabledFields.includes('auth_url') && (React.createElement(FormGroup, { fieldId: 'auth_url', label: 'SSO URL', labelIcon: React.createElement(HelperText, { content: 'Single sign on URL.' }), isRequired: requiredFields.includes('auth_url'), validated: this.toError(!('auth_url' in errorMessages)), helperTextInvalid: errorMessages['auth_url'] },
            ...
            !disabledFields.includes('requirements_file') && (React.createElement(FormGroup, { fieldId: 'yaml', label: 'YAML requirements', labelIcon: React.createElement(HelperText, { content: React.createElement(React.Fragment, null,
                        "This uses the same",
                        ' ',
                ...
                React.createElement(Flex, null,
                    ...
                    React.createElement(FlexItem, null,
                        React.createElement(Button, { isDisabled: !this.props.remote.requirements_file, onClick: function () {
                            ...
                            }, variant: 'plain', "aria-label": 'Download requirements file' },
                            React.createElement(DownloadIcon, null)))))),
            React.createElement(ExpandableSection, { toggleTextExpanded: 'Hide advanced options', toggleTextCollapsed: 'Show advanced options' },
                React.createElement(FormGroup, { fieldId: 'username', label: 'Username', labelIcon: React.createElement(HelperText, { content: 'The username to be used for authentication when syncing. This is not required when using a token.' }), isRequired: requiredFields.includes('username'), validated: this.toError(!('username' in errorMessages)), helperTextInvalid: errorMessages['username'] },
                ...
                React.createElement(FormGroup, { fieldId: 'password', label: 'Password', labelIcon: React.createElement(HelperText, { content: 'The password to be used for authentication when syncing. This is not required when using a token.' }), isRequired: requiredFields.includes('password'), validated: this.toError(!('password' in errorMessages)), helperTextInvalid: errorMessages['password'] },
                ...
                React.createElement(FormGroup, { fieldId: 'proxy_url', label: 'Proxy URL', isRequired: requiredFields.includes('proxy_url'), validated: this.toError(!('proxy_url' in errorMessages)), helperTextInvalid: errorMessages['proxy_url'] },
                ...
                React.createElement(FormGroup, { fieldId: 'proxy_username', label: 'Proxy username', isRequired: requiredFields.includes('proxy_username'), validated: this.toError(!('proxy_username' in errorMessages)), helperTextInvalid: errorMessages['proxy_username'] },
                ...
                React.createElement(FormGroup, { fieldId: 'proxy_password', label: 'Proxy password', isRequired: requiredFields.includes('proxy_password'), validated: this.toError(!('proxy_password' in errorMessages)), helperTextInvalid: errorMessages['proxy_password'] },
                    React.createElement(WriteOnlyField, { isValueSet: isFieldSet('proxy_password', remote.write_only_fields), onClear: function () { return _this.updateIsSet('proxy_password', false); } },
                        React.createElement(TextInput, { validated: this.toError(!('proxy_password' in errorMessages)), isRequired: requiredFields.includes('proxy_password'), isDisabled: disabledFields.includes('proxy_password'), id: 'proxy_password', type: 'text', value: remote.proxy_password || '', onChange: function (value) { return _this.updateRemote(value, 'proxy_password'); } }))),
                React.createElement(FormGroup, { fieldId: 'tls_validation', label: 'TLS validation', labelIcon: React.createElement(HelperText, { content: 'If selected, TLS peer validation must be performed.' }), isRequired: requiredFields.includes('tls_validation'), validated: this.toError(!('tls_validation' in errorMessages)), helperTextInvalid: errorMessages['tls_validation'] },
                ...
                React.createElement(FormGroup, { fieldId: 'client_key', label: 'Client key', labelIcon: React.createElement(HelperText, { content: 'A PEM encoded private key used for authentication.' }), isRequired: requiredFields.includes('client_key'), validated: this.toError(!('client_key' in errorMessages)), helperTextInvalid: errorMessages['client_key'] },
                    ...
                    React.createElement(Flex, null,
                        ...
                        React.createElement(FlexItem, null,
                            React.createElement(Button, { isDisabled: !this.props.remote.client_cert, onClick: function () {
                                ...
                                }, variant: 'plain', "aria-label": 'Download client certification file' },
                                React.createElement(DownloadIcon, null))))),
                React.createElement(FormGroup, { fieldId: 'ca_cert', label: 'CA certificate', labelIcon: React.createElement(HelperText, { content: 'A PEM encoded client certificate used for authentication.' }), isRequired: requiredFields.includes('ca_cert'), validated: this.toError(!('ca_cert' in errorMessages)), helperTextInvalid: errorMessages['ca_cert'] },
                    React.createElement(Flex, null,
                        React.createElement(FlexItem, { grow: { default: 'grow' } },
                        ...
                        React.createElement(FlexItem, null,
                            React.createElement(Button, { isDisabled: !this.props.remote.ca_cert, onClick: function () {
                                ...
                                }, variant: 'plain', "aria-label": 'Download CA certification file' },
                                React.createElement(DownloadIcon, null))))),
                React.createElement(FormGroup, { fieldId: 'download_concurrency', label: 'Download concurrency', labelIcon: React.createElement(HelperText, { content: 'Total number of simultaneous connections.' }), validated: remote.download_concurrency > 0 ? 'default' : 'error', helperTextInvalid: 'Number must be greater than 0' },
                ...
                React.createElement(FormGroup, { fieldId: 'rate_limit', label: 'Rate Limit', labelIcon: React.createElement(HelperText, { content: 'Limits total download rate in requests per second.' }), validated: Number.isInteger(remote.rate_limit) || remote.rate_limit === null
                        ? 'default'
                        : 'error', helperTextInvalid: 'Must be an integer.' },
