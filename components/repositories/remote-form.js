...
var RemoteForm = /** @class */ (function (_super) {
    ...
    RemoteForm.prototype.render = function () {
        ...
        return (React.createElement(Modal, { isOpen: this.props.showModal, title: t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Edit remote"], ["Edit remote"]))), variant: 'small', onClose: function () { return _this.props.closeModal(); }, actions: [
                React.createElement(Button, { isDisabled: !this.isValid(requiredFields), key: 'confirm', variant: 'primary', onClick: function () { return _this.props.saveRemote(); } }, t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Save"], ["Save"])))),
    ...
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields) {
        ...
        return (React.createElement(Form, null,
            ...
            React.createElement(ExpandableSection, { toggleTextExpanded: t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Hide advanced options"], ["Hide advanced options"]))), toggleTextCollapsed: t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Show advanced options"], ["Show advanced options"]))) },
                React.createElement("div", { className: 'pf-c-form' },
                    React.createElement(FormGroup, { fieldId: 'username', label: t(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Username"], ["Username"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["The username to be used for authentication when syncing. This is not required when using a token."], ["The username to be used for authentication when syncing. This is not required when using a token."]))) }), isRequired: requiredFields.includes('username'), validated: this.toError(!('username' in errorMessages)), helperTextInvalid: errorMessages['username'] },
