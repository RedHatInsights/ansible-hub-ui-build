...
var validateURLHelper = function (outsideError, url) {
    if (outsideError) {
...
var RemoteForm = /** @class */ (function (_super) {
    ...
    RemoteForm.prototype.render = function () {
        ...
        return (React.createElement(Modal, { isOpen: this.props.showModal, title: this.props.title || t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Edit remote"], ["Edit remote"]))), variant: 'small', onClose: function () { return _this.props.closeModal(); }, actions: [
                React.createElement(Button, { isDisabled: !this.isValid(requiredFields, remoteType), key: 'confirm', variant: 'primary', onClick: function () { return _this.props.saveRemote(); } }, t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Save"], ["Save"])))),
                React.createElement(Button, { key: 'cancel', variant: 'secondary', onClick: function () { return _this.props.closeModal(); } }, t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Cancel"], ["Cancel"])))),
    ...
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields) {
        ...
        var filename = function (field) {
            return filenames[field].original ? t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["(uploaded)"], ["(uploaded)"]))) : filenames[field].name;
        };
        ...
        return (React.createElement(Form, null,
            React.createElement(FormGroup, { fieldId: 'name', label: t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Name"], ["Name"]))), isRequired: requiredFields.includes('name'), validated: this.toError(!('name' in errorMessages)), helperTextInvalid: errorMessages['name'] },
            ...
            React.createElement(FormGroup, __assign({ fieldId: 'url', label: t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["URL"], ["URL"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["The URL of an external content source."], ["The URL of an external content source."]))) }), isRequired: requiredFields.includes('url') }, validateURLHelper(errorMessages['url'], remote.url), { helperTextIcon: React.createElement(ExclamationTriangleIcon, null), helperTextInvalidIcon: React.createElement(ExclamationCircleIcon, null) }),
            ...
            React.createElement(FormGroup, { fieldId: 'username', label: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Username"], ["Username"]))), labelIcon: React.createElement(HelperText, { content: disabledFields.includes('token')
            ...
            React.createElement(FormGroup, { fieldId: 'password', label: t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Password"], ["Password"]))), labelIcon: React.createElement(HelperText, { content: disabledFields.includes('token')
            ...
            React.createElement(ExpandableSection, { toggleTextExpanded: t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Hide advanced options"], ["Hide advanced options"]))), toggleTextCollapsed: t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Show advanced options"], ["Show advanced options"]))) },
                React.createElement("div", { className: 'pf-c-form' },
                    ...
                    React.createElement(FormGroup, { fieldId: 'proxy_username', label: t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["Proxy username"], ["Proxy username"]))), isRequired: requiredFields.includes('proxy_username'), validated: this.toError(!('proxy_username' in errorMessages)), helperTextInvalid: errorMessages['proxy_username'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'proxy_password', label: t(templateObject_26 || (templateObject_26 = __makeTemplateObject(["Proxy password"], ["Proxy password"]))), isRequired: requiredFields.includes('proxy_password'), validated: this.toError(!('proxy_password' in errorMessages)), helperTextInvalid: errorMessages['proxy_password'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'download_concurrency', label: t(templateObject_37 || (templateObject_37 = __makeTemplateObject(["Download concurrency"], ["Download concurrency"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_38 || (templateObject_38 = __makeTemplateObject(["Total number of simultaneous connections."], ["Total number of simultaneous connections."]))) }), validated: !this.isNumericSet(remote.download_concurrency) ||
                            ...
                            ? 'default'
                            : 'error', helperTextInvalid: t(templateObject_39 || (templateObject_39 = __makeTemplateObject(["Number must be greater than 0"], ["Number must be greater than 0"]))) },
                    ...
                    React.createElement(FormGroup, { fieldId: 'rate_limit', label: t(templateObject_40 || (templateObject_40 = __makeTemplateObject(["Rate Limit"], ["Rate Limit"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_41 || (templateObject_41 = __makeTemplateObject(["Limits total download rate in requests per second."], ["Limits total download rate in requests per second."]))) }), validated: !this.isNumericSet(remote.rate_limit) ||
                            Number.isInteger(remote.rate_limit)
                            ? 'default'
                            : 'error', helperTextInvalid: t(templateObject_42 || (templateObject_42 = __makeTemplateObject(["Must be an integer."], ["Must be an integer."]))) },
