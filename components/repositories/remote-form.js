...
import { ActionGroup, Alert, Button, Checkbox, ExpandableSection, Flex, FlexItem, Form, FormGroup, Modal, Switch, TextInput, } from '@patternfly/react-core';
...
var RemoteForm = /** @class */ (function (_super) {
    ...
    RemoteForm.prototype.render = function () {
        ...
        var isCommunityRemote = remoteType === 'ansible-remote' &&
            (remote === null || remote === void 0 ? void 0 : remote.url) === 'https://galaxy.ansible.com/api/';
        switch (remoteType) {
            case 'ansible-remote':
        ...
        if (showMain) {
            return (React.createElement(React.Fragment, null, this.renderForm(requiredFields, disabledFields, {
                extra: (React.createElement(ActionGroup, { key: 'actions' },
                    save,
                    cancel)),
                isCommunityRemote: isCommunityRemote,
            })));
        }
        return (React.createElement(Modal, { isOpen: showModal, title: title || t(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Edit remote"], ["Edit remote"]))), variant: 'small', onClose: function () { return closeModal(); }, actions: [save, cancel] }, this.renderForm(requiredFields, disabledFields, { isCommunityRemote: isCommunityRemote })));
    };
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields, _a) {
        var _this = this;
        var extra = _a.extra, isCommunityRemote = _a.isCommunityRemote;
        var _b = this.props, errorMessages = _b.errorMessages, remote = _b.remote, remoteType = _b.remoteType;
        ...
        return (React.createElement(Form, null,
            ...
            !disabledFields.includes('signed_only') && collection_signing ? (React.createElement(FormGroup, { fieldId: 'signed_only', label: t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Download only signed collections"], ["Download only signed collections"]))) },
                isCommunityRemote && this.props.remote.signed_only ? (React.createElement(Alert, { isInline: true, variant: 'warning', title: t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Community content will never be synced if this setting is enabled"], ["Community content will never be synced if this setting is enabled"]))) })) : null,
            ...
            !disabledFields.includes('sync_dependencies') ? (React.createElement(FormGroup, { fieldId: 'sync_dependencies', label: t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Include all dependencies when syncing a collection."], ["Include all dependencies when syncing a collection."]))) },
                React.createElement(Switch, { id: 'sync_dependencies', isChecked: !!remote.sync_dependencies, onChange: function (value) {
                        return _this.updateRemote(value, 'sync_dependencies');
                    } }))) : null,
            !disabledFields.includes('token') && (React.createElement(FormGroup, { fieldId: 'token', label: t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Token"], ["Token"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Token for authenticating to the server URL."], ["Token for authenticating to the server URL."]))) }), isRequired: requiredFields.includes('token'), validated: this.toError(!('token' in errorMessages)), helperTextInvalid: errorMessages['token'] },
                React.createElement(WriteOnlyField, { isValueSet: isFieldSet('token', writeOnlyFields), onClear: function () { return _this.updateIsSet('token', false); } },
                    React.createElement(TextInput, { validated: this.toError(!('token' in errorMessages)), isRequired: requiredFields.includes('token'), type: 'password', autoComplete: 'off', id: 'token', value: remote.token || '', onChange: function (value) { return _this.updateRemote(value, 'token'); } })))),
            !disabledFields.includes('auth_url') && (React.createElement(FormGroup, { fieldId: 'auth_url', label: t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["SSO URL"], ["SSO URL"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Single sign on URL."], ["Single sign on URL."]))) }), isRequired: requiredFields.includes('auth_url'), validated: this.toError(!('auth_url' in errorMessages)), helperTextInvalid: errorMessages['auth_url'] },
            ...
            !disabledFields.includes('requirements_file') && (React.createElement(FormGroup, { fieldId: 'yaml', label: t(templateObject_15 || (templateObject_15 = __makeTemplateObject(["YAML requirements"], ["YAML requirements"]))), labelIcon: React.createElement(HelperText, { content: React.createElement(Trans, null,
                        "This uses the same ",
                        docsAnsibleLink,
                ...
                isCommunityRemote && !this.props.remote.requirements_file ? (React.createElement(Alert, { isInline: true, variant: 'warning', title: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["YAML requirements are required to sync from Galaxy"], ["YAML requirements are required to sync from Galaxy"]))) })) : null,
                React.createElement(Flex, null,
                    ...
                    React.createElement(FlexItem, null,
                        React.createElement(Button, { isDisabled: !this.props.remote.requirements_file, onClick: function () {
                            ...
                            }, variant: 'plain', "aria-label": t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Download requirements file"], ["Download requirements file"]))) },
                            React.createElement(DownloadIcon, null)))),
                React.createElement(ExpandableSection, { toggleTextExpanded: t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Close YAML editor"], ["Close YAML editor"]))), toggleTextCollapsed: t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Edit in YAML editor"], ["Edit in YAML editor"]))) },
                    React.createElement(Flex, null,
                        React.createElement(FlexItem, { grow: { default: 'grow' } },
                            React.createElement(ExclamationTriangleIcon, null),
                            ' ', t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["If you populate this requirements file, this remote will only sync collections from this file, otherwise all collections will be synchronized."], ["If you populate this requirements file, this remote will only sync collections from this file, otherwise all collections will be synchronized."]))),
                            React.createElement(CodeEditor, { code: this.props.remote.requirements_file, isCopyEnabled: true, isDarkTheme: true, isDownloadEnabled: true, isLanguageLabelVisible: true, isUploadEnabled: true, emptyState: React.createElement(React.Fragment, null,
                                    React.createElement("pre", null, yamlTemplate),
                                    React.createElement(Button, { variant: 'plain', onClick: function () {
                                            return _this.updateRemote(yamlTemplate, 'requirements_file');
                                        } }, t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Use template"], ["Use template"])))),
                                    React.createElement(Button, { variant: 'plain', onClick: function () {
                                            return _this.updateRemote('\n', 'requirements_file');
                                        } }, t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Start from scratch"], ["Start from scratch"]))))), height: '20rem', language: Language.yaml, onChange: function (value) {
                                    return _this.updateRemote(value, 'requirements_file');
                                }, onEditorDidMount: function (editor) { return editor.focus(); } })))))),
            React.createElement(FormGroup, { "data-cy": 'username', fieldId: 'username', label: t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Username"], ["Username"]))), labelIcon: React.createElement(HelperText, { content: disabledFields.includes('token')
                        ? t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["The username to be used for authentication when syncing."], ["The username to be used for authentication when syncing."]))) : t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["The username to be used for authentication when syncing. This is not required when using a token."], ["The username to be used for authentication when syncing. This is not required when using a token."]))) }), isRequired: requiredFields.includes('username'), validated: this.toError(!('username' in errorMessages)), helperTextInvalid: errorMessages['username'] },
            ...
            React.createElement(FormGroup, { "data-cy": 'password', fieldId: 'password', label: t(templateObject_26 || (templateObject_26 = __makeTemplateObject(["Password"], ["Password"]))), labelIcon: React.createElement(HelperText, { content: disabledFields.includes('token')
                        ? t(templateObject_27 || (templateObject_27 = __makeTemplateObject(["The password to be used for authentication when syncing."], ["The password to be used for authentication when syncing."]))) : t(templateObject_28 || (templateObject_28 = __makeTemplateObject(["The password to be used for authentication when syncing. This is not required when using a token."], ["The password to be used for authentication when syncing. This is not required when using a token."]))) }), isRequired: requiredFields.includes('password'), validated: this.toError(!('password' in errorMessages)), helperTextInvalid: errorMessages['password'] },
                React.createElement(WriteOnlyField, { isValueSet: isFieldSet('password', writeOnlyFields), onClear: function () { return _this.updateIsSet('password', false); } },
                    React.createElement(TextInput, { validated: this.toError(!('password' in errorMessages)), isRequired: requiredFields.includes('password'), isDisabled: disabledFields.includes('password'), id: 'password', type: 'password', autoComplete: 'off', value: remote.password || '', onChange: function (value) { return _this.updateRemote(value, 'password'); } }))),
            React.createElement(ExpandableSection, { toggleTextExpanded: t(templateObject_29 || (templateObject_29 = __makeTemplateObject(["Hide advanced options"], ["Hide advanced options"]))), toggleTextCollapsed: t(templateObject_30 || (templateObject_30 = __makeTemplateObject(["Show advanced options"], ["Show advanced options"]))) },
                React.createElement("div", { className: 'pf-c-form' },
                    React.createElement(FormGroup, { fieldId: 'proxy_url', label: t(templateObject_31 || (templateObject_31 = __makeTemplateObject(["Proxy URL"], ["Proxy URL"]))), isRequired: requiredFields.includes('proxy_url'), validated: this.toError(!('proxy_url' in errorMessages)), helperTextInvalid: errorMessages['proxy_url'] },
                    ...
                    React.createElement(FormGroup, { "data-cy": 'proxy_username', fieldId: 'proxy_username', label: t(templateObject_32 || (templateObject_32 = __makeTemplateObject(["Proxy username"], ["Proxy username"]))), isRequired: requiredFields.includes('proxy_username'), validated: this.toError(!('proxy_username' in errorMessages)), helperTextInvalid: errorMessages['proxy_username'] },
                    ...
                    React.createElement(FormGroup, { "data-cy": 'proxy_password', fieldId: 'proxy_password', label: t(templateObject_33 || (templateObject_33 = __makeTemplateObject(["Proxy password"], ["Proxy password"]))), isRequired: requiredFields.includes('proxy_password'), validated: this.toError(!('proxy_password' in errorMessages)), helperTextInvalid: errorMessages['proxy_password'] },
                        React.createElement(WriteOnlyField, { isValueSet: isFieldSet('proxy_password', writeOnlyFields), onClear: function () { return _this.updateIsSet('proxy_password', false); } },
                            React.createElement(TextInput, { validated: this.toError(!('proxy_password' in errorMessages)), isRequired: requiredFields.includes('proxy_password'), isDisabled: disabledFields.includes('proxy_password'), id: 'proxy_password', type: 'password', autoComplete: 'off', value: remote.proxy_password || '', onChange: function (value) {
                                    return _this.updateRemote(value, 'proxy_password');
                                } }))),
                    React.createElement(FormGroup, { fieldId: 'tls_validation', label: t(templateObject_34 || (templateObject_34 = __makeTemplateObject(["TLS validation"], ["TLS validation"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_35 || (templateObject_35 = __makeTemplateObject(["If selected, TLS peer validation must be performed."], ["If selected, TLS peer validation must be performed."]))) }), isRequired: requiredFields.includes('tls_validation'), validated: this.toError(!('tls_validation' in errorMessages)), helperTextInvalid: errorMessages['tls_validation'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'client_key', label: t(templateObject_36 || (templateObject_36 = __makeTemplateObject(["Client key"], ["Client key"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_37 || (templateObject_37 = __makeTemplateObject(["A PEM encoded private key used for authentication."], ["A PEM encoded private key used for authentication."]))) }), isRequired: requiredFields.includes('client_key'), validated: this.toError(!('client_key' in errorMessages)), helperTextInvalid: errorMessages['client_key'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'client_cert', label: t(templateObject_38 || (templateObject_38 = __makeTemplateObject(["Client certificate"], ["Client certificate"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_39 || (templateObject_39 = __makeTemplateObject(["A PEM encoded client certificate used for authentication."], ["A PEM encoded client certificate used for authentication."]))) }), isRequired: requiredFields.includes('client_cert'), validated: this.toError(!('client_cert' in errorMessages)), helperTextInvalid: errorMessages['client_cert'] },
                        React.createElement(Flex, null,
                            React.createElement(FlexItem, { grow: { default: 'grow' } },
                            ...
                            React.createElement(FlexItem, null,
                                React.createElement(Button, { "data-cy": 'client_cert', isDisabled: !this.props.remote.client_cert, onClick: function () {
                                    ...
                                    }, variant: 'plain', "aria-label": t(templateObject_40 || (templateObject_40 = __makeTemplateObject(["Download client certification file"], ["Download client certification file"]))) },
                                    React.createElement(DownloadIcon, null))))),
                    React.createElement(FormGroup, { fieldId: 'ca_cert', label: t(templateObject_41 || (templateObject_41 = __makeTemplateObject(["CA certificate"], ["CA certificate"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_42 || (templateObject_42 = __makeTemplateObject(["A PEM encoded client certificate used for authentication."], ["A PEM encoded client certificate used for authentication."]))) }), isRequired: requiredFields.includes('ca_cert'), validated: this.toError(!('ca_cert' in errorMessages)), helperTextInvalid: errorMessages['ca_cert'] },
                        React.createElement(Flex, null,
                            React.createElement(FlexItem, { grow: { default: 'grow' } },
                            ...
                            React.createElement(FlexItem, null,
                                React.createElement(Button, { "data-cy": 'ca_cert', isDisabled: !this.props.remote.ca_cert, onClick: function () {
                                    ...
                                    }, variant: 'plain', "aria-label": t(templateObject_43 || (templateObject_43 = __makeTemplateObject(["Download CA certification file"], ["Download CA certification file"]))) },
                                    React.createElement(DownloadIcon, null))))),
                    React.createElement(FormGroup, { fieldId: 'download_concurrency', label: t(templateObject_44 || (templateObject_44 = __makeTemplateObject(["Download concurrency"], ["Download concurrency"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_45 || (templateObject_45 = __makeTemplateObject(["Total number of simultaneous connections."], ["Total number of simultaneous connections."]))) }), validated: !this.isNumericSet(remote.download_concurrency) ||
                            remote.download_concurrency > 0
                            ? 'default'
                            : 'error', helperTextInvalid: t(templateObject_46 || (templateObject_46 = __makeTemplateObject(["Number must be greater than 0"], ["Number must be greater than 0"]))) },
                    ...
                    React.createElement(FormGroup, { fieldId: 'rate_limit', label: t(templateObject_47 || (templateObject_47 = __makeTemplateObject(["Rate Limit"], ["Rate Limit"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_48 || (templateObject_48 = __makeTemplateObject(["Limits total download rate in requests per second."], ["Limits total download rate in requests per second."]))) }), validated: !this.isNumericSet(remote.rate_limit) ||
                            Number.isInteger(remote.rate_limit)
                            ? 'default'
                            : 'error', helperTextInvalid: t(templateObject_49 || (templateObject_49 = __makeTemplateObject(["Must be an integer."], ["Must be an integer."]))) },
