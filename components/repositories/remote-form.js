...
var RemoteForm = /** @class */ (function (_super) {
    ...
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields) {
        ...
        return (React.createElement(Form, null,
            ...
            React.createElement(FormGroup, { fieldId: 'password', label: t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Password"], ["Password"]))), labelIcon: React.createElement(HelperText, { content: disabledFields.includes('token')
                        ? t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["The password to be used for authentication when syncing."], ["The password to be used for authentication when syncing."]))) : t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["The password to be used for authentication when syncing. This is not required when using a token."], ["The password to be used for authentication when syncing. This is not required when using a token."]))) }), isRequired: requiredFields.includes('password'), validated: this.toError(!('password' in errorMessages)), helperTextInvalid: errorMessages['password'] },
            ...
            React.createElement(ExpandableSection, { toggleTextExpanded: t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Hide advanced options"], ["Hide advanced options"]))), toggleTextCollapsed: t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Show advanced options"], ["Show advanced options"]))) },
                React.createElement("div", { className: 'pf-c-form' },
                    React.createElement(FormGroup, { fieldId: 'proxy_url', label: t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Proxy URL"], ["Proxy URL"]))), isRequired: requiredFields.includes('proxy_url'), validated: this.toError(!('proxy_url' in errorMessages)), helperTextInvalid: errorMessages['proxy_url'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'proxy_username', label: t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Proxy username"], ["Proxy username"]))), isRequired: requiredFields.includes('proxy_username'), validated: this.toError(!('proxy_username' in errorMessages)), helperTextInvalid: errorMessages['proxy_username'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'proxy_password', label: t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Proxy password"], ["Proxy password"]))), isRequired: requiredFields.includes('proxy_password'), validated: this.toError(!('proxy_password' in errorMessages)), helperTextInvalid: errorMessages['proxy_password'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'tls_validation', label: t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["TLS validation"], ["TLS validation"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_25 || (templateObject_25 = __makeTemplateObject(["If selected, TLS peer validation must be performed."], ["If selected, TLS peer validation must be performed."]))) }), isRequired: requiredFields.includes('tls_validation'), validated: this.toError(!('tls_validation' in errorMessages)), helperTextInvalid: errorMessages['tls_validation'] },
                    ...
                    React.createElement(FormGroup, { fieldId: 'client_cert', label: t(templateObject_28 || (templateObject_28 = __makeTemplateObject(["Client certificate"], ["Client certificate"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_29 || (templateObject_29 = __makeTemplateObject(["A PEM encoded client certificate used for authentication."], ["A PEM encoded client certificate used for authentication."]))) }), isRequired: requiredFields.includes('client_cert'), validated: this.toError(!('client_cert' in errorMessages)), helperTextInvalid: errorMessages['client_cert'] },
                        React.createElement(Flex, null,
                            React.createElement(FlexItem, { grow: { default: 'grow' } },
                            ...
                            React.createElement(FlexItem, null,
                                React.createElement(Button, { isDisabled: !this.props.remote.client_cert, onClick: function () {
                                    ...
                                    }, variant: 'plain', "aria-label": t(templateObject_30 || (templateObject_30 = __makeTemplateObject(["Download client certification file"], ["Download client certification file"]))) },
                                    React.createElement(DownloadIcon, null))))),
                    React.createElement(FormGroup, { fieldId: 'ca_cert', label: t(templateObject_31 || (templateObject_31 = __makeTemplateObject(["CA certificate"], ["CA certificate"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_32 || (templateObject_32 = __makeTemplateObject(["A PEM encoded client certificate used for authentication."], ["A PEM encoded client certificate used for authentication."]))) }), isRequired: requiredFields.includes('ca_cert'), validated: this.toError(!('ca_cert' in errorMessages)), helperTextInvalid: errorMessages['ca_cert'] },
                        React.createElement(Flex, null,
                            React.createElement(FlexItem, { grow: { default: 'grow' } },
                            ...
                            React.createElement(FlexItem, null,
                                React.createElement(Button, { isDisabled: !this.props.remote.ca_cert, onClick: function () {
                                    ...
                                    }, variant: 'plain', "aria-label": t(templateObject_33 || (templateObject_33 = __makeTemplateObject(["Download CA certification file"], ["Download CA certification file"]))) },
                                    React.createElement(DownloadIcon, null))))),
                    React.createElement(FormGroup, { fieldId: 'download_concurrency', label: t(templateObject_34 || (templateObject_34 = __makeTemplateObject(["Download concurrency"], ["Download concurrency"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_35 || (templateObject_35 = __makeTemplateObject(["Total number of simultaneous connections."], ["Total number of simultaneous connections."]))) }), validated: !this.isNumericSet(remote.download_concurrency) ||
                            remote.download_concurrency > 0
                            ? 'default'
                            : 'error', helperTextInvalid: t(templateObject_36 || (templateObject_36 = __makeTemplateObject(["Number must be greater than 0"], ["Number must be greater than 0"]))) },
                    ...
                    React.createElement(FormGroup, { fieldId: 'rate_limit', label: t(templateObject_37 || (templateObject_37 = __makeTemplateObject(["Rate Limit"], ["Rate Limit"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_38 || (templateObject_38 = __makeTemplateObject(["Limits total download rate in requests per second."], ["Limits total download rate in requests per second."]))) }), validated: !this.isNumericSet(remote.rate_limit) ||
                            Number.isInteger(remote.rate_limit)
                            ? 'default'
                            : 'error', helperTextInvalid: t(templateObject_39 || (templateObject_39 = __makeTemplateObject(["Must be an integer."], ["Must be an integer."]))) },
