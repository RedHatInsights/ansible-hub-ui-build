...
var RemoteForm = /** @class */ (function (_super) {
    ...
    RemoteForm.prototype.renderForm = function (requiredFields, disabledFields) {
        ...
        return (React.createElement(Form, null,
            ...
            React.createElement(FormGroup, { fieldId: 'url', label: t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["URL"], ["URL"]))), labelIcon: React.createElement(HelperText, { content: t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["The URL of an external content source."], ["The URL of an external content source."]))) }), isRequired: requiredFields.includes('url'), validated: this.toError(!('url' in errorMessages)), helperTextInvalid: errorMessages['url'] },
