...
var PermissionChipSelector = /** @class */ (function (_super) {
    ...
    PermissionChipSelector.prototype.render = function () {
        ...
        return (React.createElement(Select, { menuAppendTo: this.props.menuAppendTo, variant: SelectVariant.typeaheadMulti, typeAheadAriaLabel: 'Select permissions', onToggle: this.onToggle, onSelect: !!this.props.onSelect ? this.props.onSelect : this.onSelect, onClear: !!this.props.onClear ? this.props.onClear : this.clearSelection, selections: this.props.selectedPermissions, isOpen: this.state.isOpen, placeholderText: this.placeholderText(), isDisabled: !!this.props.isDisabled }, this.props.availablePermissions.length === 0
            ? [
                React.createElement(SelectOption, { isDisabled: true, key: 'not_found', value: 'Not found' }),
            ]
