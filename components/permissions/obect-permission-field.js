...
var ObjectPermissionField = /** @class */ (function (_super) {
    ...
    ObjectPermissionField.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(APISearchTypeAhead, { results: this.state.searchGroups, loadResults: this.loadGroups, onSelect: this.onSelect, placeholderText: _(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Find a group"], ["Find a group"]))), menuAppendTo: this.props.menuAppendTo, isDisabled: !!this.props.isDisabled }),
