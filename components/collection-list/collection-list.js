...
export var CollectionList = function (props) {
    var collections = props.collections, displaySignatures = props.displaySignatures, params = props.params, updateParams = props.updateParams, ignoredParams = props.ignoredParams, itemCount = props.itemCount, showControls = props.showControls, repo = props.repo;
    return (React.createElement(React.Fragment, null,
        React.createElement(DataList, { "aria-label": t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["List of Collections"], ["List of Collections"]))) }, collections.length > 0 ? (collections.map(function (c) { return (React.createElement(CollectionListItem, __assign({ controls: showControls ? props.renderCollectionControls(c) : null, key: c.id }, c, { repo: repo, displaySignatures: displaySignatures }))); })) : (React.createElement(EmptyStateFilter, { clearAllFilters: function () {
