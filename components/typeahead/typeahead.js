...
var APISearchTypeAhead = /** @class */ (function (_super) {
    ...
    APISearchTypeAhead.prototype.render = function () {
        ...
        return (React.createElement(Select, { menuAppendTo: this.props.menuAppendTo, onClear: this.onClear, onSelect: this.onSelect, onToggle: this.onToggle, variant: variant, selections: selected, isOpen: isOpen, hasInlineFilter: true, onFilter: this.onFilter, placeholderText: this.props.placeholderText, isDisabled: this.props.isDisabled }, this.getOptions()));
    };
    APISearchTypeAhead.prototype.getOptions = function () {
        ...
        if (options.length === 0) {
            options.push(React.createElement(SelectOption, { key: 'not_found', value: 'Not found', isDisabled: true }));
        }
        return options;
    };
