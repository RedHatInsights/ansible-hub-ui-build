...
var PartnerHeader = /** @class */ (function (_super) {
    ...
    PartnerHeader.prototype.render = function () {
        var _a = this.props, breadcrumbs = _a.breadcrumbs, contextSelector = _a.contextSelector, namespace = _a.namespace, pageControls = _a.pageControls, params = _a.params, tabs = _a.tabs, updateParams = _a.updateParams;
        return (React.createElement(BaseHeader, { title: namespace.company || namespace.name, imageURL: namespace.avatar_url, breadcrumbs: React.createElement(Breadcrumbs, { links: breadcrumbs }), pageControls: pageControls, contextSelector: contextSelector },
