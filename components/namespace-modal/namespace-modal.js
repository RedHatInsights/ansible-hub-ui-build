...
var NamespaceModal = /** @class */ (function (_super) {
    ...
    NamespaceModal.prototype.render = function () {
        ...
        return (React.createElement(Modal, { variant: 'large', title: 'Create a new namespace', isOpen: this.props.isOpen, onClose: this.toggleModal, actions: [
                React.createElement(Button, { key: 'confirm', variant: 'primary', onClick: this.handleSubmit, isDisabled: !newNamespaceName || !newNamespaceNameValid }, "Create"),
                React.createElement(Button, { key: 'cancel', variant: 'link', onClick: this.toggleModal }, "Cancel"),
            ] },
            React.createElement(Form, null,
                React.createElement(FormGroup, { label: 'Name', isRequired: true, fieldId: 'name', helperText: 'Please, provide the namespace name', helperTextInvalid: this.state.errorMessages['name'], validated: this.toError(this.state.newNamespaceNameValid), labelIcon: React.createElement(HelperText, { content: 'Namespace names are limited to alphanumeric characters and underscores, must have a minimum length of 2 characters and cannot start with an ‘_’.' }) },
                ...
                React.createElement(FormGroup, { label: 'Namespace owners', fieldId: 'groups', helperTextInvalid: this.state.errorMessages['groups'] },
