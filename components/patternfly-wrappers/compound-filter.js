...
var CompoundFilter = /** @class */ (function (_super) {
    ...
    CompoundFilter.prototype.render = function () {
        ...
        return (React.createElement(InputGroup, null,
            ...
            React.createElement(Button, { onClick: function () { return _this.submitFilter(); }, variant: ButtonVariant.control },
    ...
    CompoundFilter.prototype.renderInput = function (selectedFilter) {
        ...
        switch (selectedFilter.inputType) {
            case 'multiple':
                ...
                var toggle = [
                    React.createElement(SelectGroup, { label: 'Filter by ' + selectedFilter.id, key: selectedFilter.id }, options),
                ];
                return (React.createElement(Select, { variant: SelectVariant.checkbox, onToggle: this.onToggle, onSelect: this.onSelectMultiple, isOpen: this.state.isOpen, placeholderText: 'Filter by ' + selectedFilter.id.toLowerCase(), selections: this.props.params[this.state.selectedFilter.id], isGrouped: true }, toggle));
            case 'select':
                return (React.createElement(StatefulDropdown, { toggleType: 'dropdown', defaultText: this.state.inputText ||
            ...
            default:
                return (React.createElement(TextInput, { "aria-label": selectedFilter.id, placeholder: selectedFilter.placeholder ||
                        "Filter by " + selectedFilter.title.toLowerCase(), value: this.state.inputText, onChange: function (k) { return _this.setState({ inputText: k }); }, onKeyPress: function (e) { return _this.handleEnter(e); } }));
        }
    };
