...
var Sort = /** @class */ (function (_super) {
    ...
    Sort.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'sort-wrapper' },
            options.length > 1 ? (React.createElement(Select, { variant: SelectVariant.single, "aria-label": 'Select input', onToggle: function (e) { return _this.onToggle(e); }, onSelect: function (_, name) { return _this.onSelect(name); }, selections: selectedOption.title, isOpen: isExpanded, "aria-labelledby": 'Sort results' }, options.map(function (option) { return (React.createElement(SelectOption, { key: option.id, value: option.title })); }))) : null,
