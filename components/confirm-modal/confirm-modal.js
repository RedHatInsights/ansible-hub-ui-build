...
var ConfirmModal = /** @class */ (function (_super) {
    ...
    ConfirmModal.prototype.render = function () {
        var _a = this.props, cancelAction = _a.cancelAction, children = _a.children, confirmAction = _a.confirmAction, isDisabled = _a.isDisabled, title = _a.title, spinner = _a.spinner, confirmButtonTitle = _a.confirmButtonTitle;
