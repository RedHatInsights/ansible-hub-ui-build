    ...
    PublishToControllerModal.prototype.render = function () {
        ...
        var notListedMessage = (React.createElement(React.Fragment, null, t(templateObject_4 || (templateObject_4 = __makeTemplateObject(["If the Controller is not listed in the table, check settings.py."], ["If the Controller is not listed in the table, check settings.py."]))),
            ...
            docsLink && (React.createElement(React.Fragment, null,
                React.createElement("a", { href: docsLink, target: '_blank' }, t(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Learn more"], ["Learn more"])))),
                ' ',
                React.createElement(ExternalLinkAltIcon, null)))));
        var Spacer = function () { return React.createElement("div", { style: { paddingTop: '24px' } }); };
        return (React.createElement(Modal, { variant: 'large', title: t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Use in Controller"], ["Use in Controller"]))), isOpen: isOpen, onClose: onClose, actions: [
                React.createElement(Button, { key: 'close', variant: 'primary', onClick: onClose }, t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Close"], ["Close"])))),
            ] },
