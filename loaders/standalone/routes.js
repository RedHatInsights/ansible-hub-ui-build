...
import { CertificationDashboard, CollectionContent, CollectionDetail, CollectionDocs, CollectionImportLog, EditNamespace, LoginPage, MyImports, NamespaceDetail, MyNamespaces, Partners, NotFound, Search, TokenPageStandalone, UserList, EditUser, UserDetail, UserCreate, UserProfile, GroupList, GroupDetail, RepositoryList, ExecutionEnvironmentList, ExecutionEnvironmentDetail, ExecutionEnvironmentDetailActivities, ExecutionEnvironmentDetailImages, ExecutionEnvironmentManifest, } from 'src/containers';
    ...
    AuthHandler.prototype.componentDidMount = function () {
        ...
        if (!user) {
            Promise.all([ActiveUserAPI.getUser(), FeatureFlagsAPI.get()])
                ...
                _this.props.updateInitialData(response[0], response[1].data, function () {
